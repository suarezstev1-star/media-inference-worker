...
def build_hero(src="hero_video_veo.mp4", out="hero_video.mp4", size=(1080, 1920)):
    layers = [
        ...
        {"img": text_beat_png(size, ["Un funeral cuesta", "hasta $12,000."],
                              ov.SERIF, 0.072, ov.WHITE, 0.60),
         "start": 0.2, "end": 2.5},
        {"img": text_beat_png(size, ["No se lo dejes", "a tus hijos."],
                              ov.SERIF, 0.080, ov.GOLD, 0.60),
         "start": 2.5, "end": 4.3},
...
def build_product(src="prod_llamada_veo.mp4", out="comercial_llamada.mp4",
    ...
    layers = [
        {"img": scrim_png(size), "start": None, "end": None},
        {"img": text_beat_png(size, ["Deja de", "posponerlo."],
                              ov.SERIF, 0.080, ov.WHITE, 0.58),
         "start": 0.2, "end": 2.4},
        {"img": text_beat_png(size, ["Tu plan listo", "en una llamada."],
...
def build_vida(src="prod_vida_veo.mp4", out="comercial_vida.mp4",
    ...
    layers = [
        {"img": scrim_png(size), "start": None, "end": None},
        {"img": text_beat_png(size, ["Sin un plan,", "tu familia paga."],
                              ov.SERIF, 0.072, ov.WHITE, 0.58),
         "start": 0.2, "end": 2.4},
        {"img": text_beat_png(size, ["Protégelos", "de por vida."],
                              ov.SERIF, 0.080, ov.GOLD, 0.60),
         "start": 2.4, "end": 4.2},
        {"img": cta_beat_png(size, 0.66), "start": 4.2, "end": 99},
        {"img": wordmark_png(size), "start": None, "end": None},
...
def build_iul(src="prod_iul_veo.mp4", out="comercial_iul.mp4",
    ...
    layers = [
        {"img": scrim_png(size), "start": None, "end": None},
        {"img": text_beat_png(size, ["Haz que tu dinero", "trabaje por ti."],
                              ov.SERIF, 0.068, ov.WHITE, 0.58),
         "start": 0.2, "end": 2.6},
